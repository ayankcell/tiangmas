                        ...
                        <div class="w-full md:w-1/2 lg:w-1/3 p-3" v-for="content in list" :key="content._path">
                            <NuxtLink :to="content._path"
                                ...
                                <div class="flex-grow overflow-hidden">
                                    <NuxtImg :src="content.image.url" provider="photon" width="346" height="272" quality="80" class="w-full object-cover h-full" loading="lazy"
                                        :placeholder="placeHolder('',{width:100, height:100})" :alt="content.image.altText"/>
                                    <div
                                        ...
                                        <div class="line-clamp-3">{{ content.head.description }}</div>
