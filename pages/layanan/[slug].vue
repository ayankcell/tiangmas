    ...
    <NuxtLayout>
        <main class="pt-5 pb-16 lg:pt-16 lg:pb-24 bg-white after:antialiased">
            <div class="max-w-screen-xl mx-auto flex justify-center items-center -mt-8 lg:-mt-16">
                <nuxt-img provider="photon" v-if="pageData.coverImage" :src="pageData.coverImage.url" class="w-full lg:w-[768px] lg:h-[519px] object-cover" width="768"
                    height="519"  quality="80" :placeholder="placeHolder(pageData.coverImage.url)" :alt="pageData.coverImage.altText"/>
            </div>
